...
if os.path.exists(datasets_path):
  ...
  # Filtro insensible a mayúsculas/minúsculas para extensiones (.csv, .xlsx, .xls)
  archivos_validos = [
      f for f in archivos if f.lower().endswith((".csv", ".xlsx", ".xls"))
  ]
  ...
  if archivos_validos:
    ...
    st.sidebar.warning(
        "La carpeta 'datasets' está vacía en GitHub o los archivos tienen otra"
        " extensión."
    )
    st.sidebar.write("Archivos detectados en la carpeta:", archivos)
else:
